...
public class CodeMsg {
    ...
    //订单模块
    //秒杀模块
    public static CodeMsg ORDER_NOT_EXIST = new CodeMsg(500401,"订单不存在");//常量
    public static CodeMsg MIAO_SHA_OVER = new CodeMsg(500500,"商品已经秒杀完毕");//常量
    public static CodeMsg REPEATE_MIAOSHA = new CodeMsg(500501,"不能重复秒杀");//常量
